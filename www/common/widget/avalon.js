...
/*新增api方法*/
avalon.prependChild = function(parent,newChild){
...
avalon.configSource = function(srcArr){
        if(srcArr.length<=1){
            avalon.prependChild(document.body,avalon.parseHTML(srcArr[0]));
        }else{
            for(var i=0;i<srcArr.length;i++){
                avalon.prependChild(document.body,avalon.parseHTML(srcArr[i]));
            }
        }
 };
